...
describe Machine do
  ...
  describe '#all_machines_in_machine_group' do
    it 'should return this machine and all machines group together with it' do
      ...
      expect(@m.all_machines_in_machine_group).must_include @m, sassy_champ
    end
  end
...
HERE
      ...
      expect(m1.reload.opdb_img).must_equal 'https://img.opdb.org/46a61cc7-8a85-4483-bc7c-d42251419868-medium.jpg'
      expect(m2.reload.opdb_img).must_equal 'https://img.opdb.org/1f4c8baa-3263-45cc-9cdf-8bca641f5270-medium.jpg'
      expect(m3.reload.opdb_img).must_equal nil
    end
  end
end
